...
import { menuCategories, productType, quickLinksData } from '@/constants'
      ...
      <Container>
        ...
        <div className='py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          <div className='space-y-4'>
            <Logo>BFOOD</Logo>
            <p className='text-gray-600 text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. In at recusandae asperiores quis rerum dolores consequatur unde ex exercitationem. Quis?</p>
            <SocialMedia
